                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <form action="{{ route('post.destroy', $post->id) }}" method="post" id="deleteForm{{$post->id}}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger m-1 deleteButton" data-post-id="{{$post->id}}" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal" fdprocessedid="sh46d8"><i class="bi bi-trash-fill"></i></button>
                                            </form>
                                            <script>
